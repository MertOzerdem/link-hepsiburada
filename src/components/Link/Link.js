...
const Link = ({ voteCount = 0, label = "Default Link", link = 'https://defaultLink.com' }) => {
    ...
    return (
        ...
        >
            ...
            {isHovered && <svg className={styles.delete} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
